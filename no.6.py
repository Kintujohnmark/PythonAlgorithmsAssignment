...
astar_result = astar(graph, start_node, goal_node, heuristics)
greedy_result = greedy(graph, start_node, goal_node, heuristics)


# Breadth-First Search
bfs_path, bfs_expanded, bfs_unexpanded = bfs(graph, start_node, goal_node)
...
# Depth-First Search
dfs_path, dfs_expanded, dfs_unexpanded = dfs(graph, start_node, goal_node)
...
# Uniform Cost Search
ucs_path, ucs_expanded, ucs_unexpanded = ucs(graph, start_node, goal_node)
...
astar_path, astar_expanded = astar(graph, start_node, goal_node, heuristics)
...
greedy_path, greedy_expanded = greedy(graph, start_node, goal_node, heuristics)
